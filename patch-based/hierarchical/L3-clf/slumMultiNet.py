...
network = conv_2d(network, 64, 9, strides=1, activation='relu', regularizer='L2',name = 'conv1_3_3_2', weights_init='Xavier')
...
model = tflearn.DNN(network, checkpoint_path='../../models/filtered-model-6-cl-final/model-', max_checkpoints = 3, tensorboard_verbose=1)

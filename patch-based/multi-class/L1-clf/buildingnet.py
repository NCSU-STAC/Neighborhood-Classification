#####
# Network to detect urban area mask 
# @author: Krishna Karthik Gadiraju/kkgadiraju
# References: TFLearn documentation and examples
####
...
model = tflearn.DNN(network, checkpoint_path='../models/filtered-model-2-cl-final/model-', max_checkpoints = 3, tensorboard_verbose=1)

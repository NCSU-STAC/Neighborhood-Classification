...
vector = fiona.open('/pvfs2/kgadira\@oss-storage-0-108/pvfs2/kgadira/data/gt10e/gt10e.shp')
...
for feat in vector:
    ...
    i+=1
    #if i % 5000 == 0 and i > 0:
    out_str = '\rPatch ID# = {}| row = {} | col = {} | probabilities = {} | class = {}\n'.format(feat['properties']['ID'],row, col, result ,prediction)
...
#f = '/home/kgadira/results/CNN-clf-L1-{}-{}.bin'.format(START, END)

...
# Read files 
trainX = np.load('/home/kgadira/data/final-px-tr-3-Xa')
trainY = np.load('/home/kgadira/data/final-px-tr-3-Ya')
testX = np.load('/home/kgadira/data/final-px-te-3-Xa')
testY = np.load('/home/kgadira/data/final-px-te-3-Ya')
